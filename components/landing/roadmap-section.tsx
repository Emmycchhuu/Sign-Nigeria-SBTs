        ...
        <section className="py-20 relative overflow-hidden" id="roadmap">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="relative">
                    ...
                    <div className="absolute top-0 left-8 md:left-1/2 -translate-x-1/2 w-[2px] h-full bg-gradient-to-b from-transparent via-primary/30 to-transparent z-0" />
                    ...
                    {phases.map((phase, index) => (
                        <motion.div
                            ...
                            className={`relative flex items-center justify-between mb-12 w-full md:flex-row ${phase.align === "left" ? "md:flex-row" : "md:flex-row-reverse"
                                }`}
                        >
                            {/* Mobile: Space for the line on the left */}
                            <div className="md:hidden w-16 flex-shrink-0" />

                            {/* Content Card */}
                            <div className="w-full md:w-[45%] pl-4 md:pl-0">
                                <div className="glass-card p-6 md:p-6 rounded-3xl border border-white/10 hover:border-primary/30 transition-colors relative group">
                                    {/* Date Badge */}
                                    <div className="absolute -top-4 left-6 md:left-8 px-4 py-1 rounded-full bg-black/80 border border-white/10 text-xs font-bold text-gray-300 uppercase tracking-wider">
                                        {phase.date}
                                    </div>

                                    <h3 className="text-lg md:text-xl font-bold mb-2 mt-2">{phase.title}</h3>
                            ...
                            {/* Center Node */}
                            <div className="absolute left-8 md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-black border-2 border-primary shadow-[0_0_10px_rgba(0,208,132,0.5)] z-20">
